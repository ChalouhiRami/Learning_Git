CREATE TABLE IF NOT EXISTS dwreporting.agg_subregion_disasters (
...
INSERT INTO dwreporting.agg_subregion_disasters (
    subregion_name,
    disaster_name,
...
SELECT
    ...
    (
        ...
        FROM (
            ...
            WHERE subregion_id = fd.subregion_id AND disaster_id = fd.disaster_id
            GROUP BY month
...
JOIN
    dwreporting.dim_subregion sr ON fd.subregion_id = sr.id
JOIN
    dwreporting.dim_disaster d ON fd.disaster_id = d.id
GROUP BY
    sr.name, d.disaster_name;
